...
UniteArmeeInfanterie::UniteArmeeInfanterie(std::string _nom, std::string _desc, int _ressMax, int _deplacementMax, int _champVision,
...
bool UniteArmeeInfanterie::isInfanterie()
{
	return true;
}